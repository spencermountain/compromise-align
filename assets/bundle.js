...
nlp.extend(_dereq_('./src'));
var el = document.querySelector('#text');

var doit = function doit(match) {
  var doc = nlp(el.value);
  var html = doc.htmlAlign(match);
  document.querySelector('#result').innerHTML = html;
};

var m = document.querySelector('#match');
...
},{"./src":4,"/Users/spencer/mountain/compromise/src":158}],2:[function(_dereq_,module,exports){
...
},{"htm":2,"vhtml":3}],5:[function(_dereq_,module,exports){
...
},{"../Phrase/Phrase":76,"../Term/Term":120,"./Pool":8,"./_linkTerms":9}],11:[function(_dereq_,module,exports){
"use strict";
...
},{"../Phrase/Phrase":76,"../Term/Term":120,"./01-sentences":6,"./02-words":7,"./Pool":8,"./_linkTerms":9}],12:[function(_dereq_,module,exports){
"use strict";
...
},{"./data/startsWith":19}],15:[function(_dereq_,module,exports){
"use strict";
...
},{"./data/endsWith":18,"./data/suffixMap":20}],16:[function(_dereq_,module,exports){
"use strict";
...
},{"./data/emoticons":17}],17:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-lexicon":12,"./02-punctuation":13,"./03-prefixes":14,"./04-suffixes":15,"./05-emoji":16}],22:[function(_dereq_,module,exports){
"use strict";
...
},{"./data/markov":29}],23:[function(_dereq_,module,exports){
"use strict";
...
},{"./data/isPlural":28}],26:[function(_dereq_,module,exports){
"use strict";
...
},{"./data/organizations":30}],27:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-neighbours":22,"./02-case":23,"./03-stem":24,"./04-plurals":25,"./05-organizations":26,"./06-acronyms":27}],32:[function(_dereq_,module,exports){
"use strict";
...
var createPhrase = function createPhrase(found, doc) {
  ...
  var phrase = tokenize(found.join(' '), doc.world, doc.pool())[0]; //tag it
...
var contractions = function contractions(doc) {
  ...
  doc.list.forEach(function (p) {
    ...
    for (var i = 0; i < terms.length; i += 1) {
      var term = terms[i];
      var found = checkNegative(term, p);
...
},{"../../01-tokenizer":11,"../01-init/01-lexicon":12,"./01-negative":32,"./02-simple":33,"./03-irregulars":34,"./04-possessive":35,"./05-perfectTense":36,"./06-ranges":37}],39:[function(_dereq_,module,exports){
"use strict";
...
var verbs = '(may|march|sat)'; //ambiguous month-verbs
...
var fixDates = function fixDates(doc) {
  ...
  if (verb.found === true) {
    ...
    verb.match("".concat(preps, " [").concat(verbs, "]")).tag('Date', 'in-month').match('(may|march)').tag('Month'); //this march

    verb.match("(next|this|last) [".concat(verbs, "]")).tag('Date', 'this-month').match('(may|march)').tag('Month'); //with date

    verb.match("[".concat(verbs, "] the? #Value")).tag('Date', 'march-5th').match('(may|march)').tag('Month');
    verb.match("#Value of? [".concat(verbs, "]")).tag('Date', '5th-of-march').match('(may|march)').tag('Month'); //nearby

    verb.match("[".concat(verbs, "] .? #Date")).tag('Date', 'march-and-feb').match('(may|march)').tag('Month');
    verb.match("#Date .? [".concat(verbs, "]")).tag('Date', 'feb-and-march').match('(may|march)').tag('Month');
...
},{"./fixAdjective":39,"./fixDates":40,"./fixMisc":41,"./fixNouns":42,"./fixPerson":43,"./fixThe":44,"./fixValue":45,"./fixVerb":46}],48:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-init":21,"./02-fallbacks":31,"./03-contractions":38,"./04-correction":47}],49:[function(_dereq_,module,exports){
"use strict";
...
Doc.prototype.fromText = function (str) {
  var list = tokenize(str, this.world, this.pool());
...
},{"../01-tokenizer":11,"../02-tagger":48,"../Subset":119,"../Subset/_simple":118,"./methods":59}],50:[function(_dereq_,module,exports){
"use strict";
...
var parseToken = _dereq_('./parseToken'); // const cache = {}
...
},{"./parseToken":50}],52:[function(_dereq_,module,exports){
"use strict";
...
},{"../match/syntax":51}],55:[function(_dereq_,module,exports){
"use strict";
...
},{"./_setTag":58}],56:[function(_dereq_,module,exports){
"use strict";
...
var lookupObject = function lookupObject(doc, obj) {
  ...
  Object.keys(obj).forEach(function (k) {
    ...
    var a = tokenize(str).map(function (s) {
      return s.trim();
    });
...
},{"../../01-tokenizer/02-words":7}],58:[function(_dereq_,module,exports){
"use strict";
...
module.exports = Object.assign({}, _dereq_('./01-utils'), _dereq_('./02-accessors'), _dereq_('./03-match'), _dereq_('./04-tag'), _dereq_('./05-loops'), _dereq_('./06-lookup'), _dereq_('./insert/01-replace'), _dereq_('./insert/02-insert'), _dereq_('./output/01-text'), _dereq_('./output/02-json'), _dereq_('./output/03-out'), _dereq_('./transform/01-sort'), _dereq_('./transform/02-normalize'), _dereq_('./transform/03-split'), _dereq_('./transform/04-case'), _dereq_('./transform/05-whitespace'), _dereq_('./transform/06-join'), _dereq_('./transform/07-contract'));

},{"./01-utils":52,"./02-accessors":53,"./03-match":54,"./04-tag":55,"./05-loops":56,"./06-lookup":57,"./insert/01-replace":60,"./insert/02-insert":61,"./output/01-text":62,"./output/02-json":63,"./output/03-out":64,"./transform/01-sort":68,"./transform/02-normalize":69,"./transform/03-split":70,"./transform/04-case":71,"./transform/05-whitespace":72,"./transform/06-join":73,"./transform/07-contract":74}],60:[function(_dereq_,module,exports){
"use strict";
...
exports.replaceWith = function (replace) {
  ...
  this.list.forEach(function (p) {
    ...
    if (input && _typeof(input) === 'object' && input.isA === 'Doc') {
      ...
      newPhrases = tokenize(input, _this.world, _this.pool()); //tag the new phrases
...
},{"../../../01-tokenizer":11}],61:[function(_dereq_,module,exports){
"use strict";
...
exports.append = function (str) {
  ...
  this.list.forEach(function (p) {
    //build it
    var phrase = tokenize(str, _this.world, _this.pool())[0]; //assume it's one sentence, for now
    //tag it
...
exports.prepend = function (str) {
  ...
  this.list.forEach(function (p) {
    //build it
    var phrase = tokenize(str, _this2.world, _this2.pool())[0]; //assume it's one sentence, for now
    //tag it
...
exports.concat = function () {
  ...
  for (var i = 0; i < arguments.length; i++) {
    ...
    if (typeof arg === 'string') {
      var arr = tokenize(arg, this.world); //TODO: phrase.tagger()?
...
},{"../../../01-tokenizer":11}],62:[function(_dereq_,module,exports){
"use strict";
...
},{"./_offset":66}],64:[function(_dereq_,module,exports){
"use strict";
...
},{"./_debug":65,"./_topk":67}],65:[function(_dereq_,module,exports){
"use strict";
...
},{"../../../World/tags":147}],66:[function(_dereq_,module,exports){
"use strict";
...
},{"./_methods":75}],70:[function(_dereq_,module,exports){
"use strict";
...
},{"../../match/syntax":51}],71:[function(_dereq_,module,exports){
"use strict";
...
},{"../../../Term/normalize/unicode":133}],76:[function(_dereq_,module,exports){
"use strict";
...
},{"./match":84,"./methods":92}],77:[function(_dereq_,module,exports){
"use strict";
...
var postProcess = _dereq_('./04-postProcess');
...
var matchAll = function matchAll(p, regs) {
  ...
  if (regs[0].start === true) {
    var _tryMatch = tryMatch(terms, regs, 0, terms.length),
  ...
  for (var i = 0; i < terms.length; i += 1) {
    ...
    var _tryMatch3 = tryMatch(terms.slice(i), regs, i, terms.length),
...
},{"../../Doc/match/syntax":51,"./02-failFast":81,"./03-tryMatch":82,"./04-postProcess":83}],81:[function(_dereq_,module,exports){
"use strict";
...
var makeId = _dereq_('../../Term/_id'); // i formally apologize for how complicated this is.
  ...
  for (var r = 0; r < regs.length; r += 1) {
    ...
    if (hasGroup) {
      ...
      if (prev && prev.named === reg.named && previousGroupId) {
        ...
        groupCounter++;
        namedGroupId = makeId(isNamedGroup ? reg.named : groupCounter); // namedGroupId = terms[t].id
...
},{"../../Term/_id":121}],83:[function(_dereq_,module,exports){
"use strict";
...
exports.match = function (str) {
  ...
  var matches = matchAll(this, str, justOne); //make them phrase objects
...
},{"./01-matchAll":80,"./not":85}],85:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-matchAll":80}],86:[function(_dereq_,module,exports){
"use strict";
...
},{"../insert/append":77,"../insert/delete":78,"../insert/prepend":79}],90:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-utils":86,"./02-text":87,"./03-change":88,"./04-insert":89,"./05-json":90,"./06-lookahead":91}],93:[function(_dereq_,module,exports){
"use strict";
...
},{"./methods":100}],100:[function(_dereq_,module,exports){
"use strict";
...
},{"./getArticle":98,"./parse":101,"./plural/hasPlural":102,"./plural/isPlural":104,"./toPossessive":105}],101:[function(_dereq_,module,exports){
"use strict";
...
},{"./_rules":103}],105:[function(_dereq_,module,exports){
"use strict";
...
},{"../toInfinitive":116,"./toBe":111}],111:[function(_dereq_,module,exports){
"use strict";
...
},{"../isPlural":113}],112:[function(_dereq_,module,exports){
"use strict";
...
},{"./methods":114}],113:[function(_dereq_,module,exports){
"use strict";
...
module.exports = {
  ...
  toInfinitive: function toInfinitive() {
    ...
    this.forEach(function (vb) {
      ...
      var str = _conjugate(parsed, _this8.world).Infinitive;
...
},{"./conjugate":110,"./isPlural":113,"./parse":115,"./toNegative":117}],115:[function(_dereq_,module,exports){
"use strict";
...
},{"./isPlural":113,"./toInfinitive":116}],118:[function(_dereq_,module,exports){
"use strict";
...
},{"./Abbreviations":93,"./Acronyms":94,"./Clauses":95,"./Contractions":96,"./Lists":97,"./Nouns":99,"./Parentheses":106,"./People":107,"./Possessives":108,"./Quotations":109,"./Verbs":112,"./_simple":118}],120:[function(_dereq_,module,exports){
"use strict";
...
},{"./_id":121,"./methods":129,"./parse":134,"./tag":138}],121:[function(_dereq_,module,exports){
"use strict";
...
},{"../normalize/isAcronym":131,"./_doesMatch":128}],125:[function(_dereq_,module,exports){
"use strict";
...
},{"../normalize/unicode":133}],126:[function(_dereq_,module,exports){
"use strict";
...
},{"./_bestTag":127}],127:[function(_dereq_,module,exports){
"use strict";
...
},{"./01-case":122,"./02-punctuation":123,"./03-misc":124,"./04-text":125,"./05-json":126}],130:[function(_dereq_,module,exports){
"use strict";
...
},{"./isAcronym":131,"./unicode":133}],131:[function(_dereq_,module,exports){
"use strict";
...
},{"./normalize/clean":130,"./normalize/reduce":132}],135:[function(_dereq_,module,exports){
"use strict";
...
},{"./fns":137}],136:[function(_dereq_,module,exports){
...
},{"./add":135,"./canBe":136,"./unTag":139}],139:[function(_dereq_,module,exports){
"use strict";
...
},{"./fns":137}],140:[function(_dereq_,module,exports){
"use strict";
...
},{"../transforms/adjectives":159,"../transforms/conjugate":164,"../transforms/toInfinitive":168,"../transforms/toPlural":170,"../transforms/toSingular":172,"./_data":141,"./addIrregulars":142,"./addWords":143,"./data/conjugations":144,"./data/misc":145,"./data/plurals":146,"./tags":147,"./tags/inference":152,"efrt-unpack":5}],141:[function(_dereq_,module,exports){
"use strict";
...
},{"./inference/index":152,"./tags/misc":153,"./tags/nouns":154,"./tags/values":155,"./tags/verbs":156}],148:[function(_dereq_,module,exports){
"use strict";
...
},{"./_color":148,"./_isA":149,"./_lineage":150,"./_notA":151}],153:[function(_dereq_,module,exports){
"use strict";
...
var fromJSON = _dereq_('./01-tokenizer/fromJSON');

var version = _dereq_('./_version');

var World = _dereq_('./World/World');

var Doc = _dereq_('./Doc/Doc');

var Phrase = _dereq_('./Phrase/Phrase');

var Term = _dereq_('./Term/Term');

var Pool = _dereq_('./01-tokenizer/Pool');
...
},{"./01-tokenizer":11,"./01-tokenizer/Pool":8,"./01-tokenizer/fromJSON":10,"./Doc/Doc":49,"./Phrase/Phrase":76,"./Term/Term":120,"./World/World":140,"./_version":157}],159:[function(_dereq_,module,exports){
"use strict";
...
},{"./toComparative":160,"./toSuperlative":161}],160:[function(_dereq_,module,exports){
"use strict";
...
},{"./suffixes":165}],163:[function(_dereq_,module,exports){
"use strict";
...
module.exports = conjugate; // console.log(conjugate('bake'))

},{"./01-suffixes":162,"./02-generic":163}],165:[function(_dereq_,module,exports){
"use strict";
...
},{"./_guess":166,"./_transform":167}],169:[function(_dereq_,module,exports){
"use strict";
...
},{"./_rules":169}],171:[function(_dereq_,module,exports){
"use strict";
